...
public class RefinedInfiniStorageCrateTileEntity extends LockableLootTileEntity {
    ...
    public RefinedInfiniStorageCrateTileEntity(TileEntityType<?> typeIn) {
        super(typeIn);
    }

    public RefinedInfiniStorageCrateTileEntity(){
        this(InfiniTileEntityTypes.REFINED_INFINI_STORAGE_CRATE.get());
    }
    ...
    public ITextComponent getDefaultName() {
        return new TranslationTextComponent("container.refined_infini_storage_crate");
    }

    @Override
    public Container createMenu(int id, PlayerInventory player) {
        return new RefinedInfiniStorageCrateContainer(id, player, this);
    }
    ...
    public static int getPlayersUsing(IBlockReader reader, BlockPos pos){
        ...
        if(blockState.hasTileEntity()){
            ...
            if(tileEntity instanceof RefinedInfiniStorageCrateTileEntity){
                return((RefinedInfiniStorageCrateTileEntity)tileEntity).numPlayersUsing;
            }
        }
        return 0;
    }

    public static void swapContents(RefinedInfiniStorageCrateTileEntity te, RefinedInfiniStorageCrateTileEntity otherTe){
