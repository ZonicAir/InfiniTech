...
public class InfiniStorageCrateTileEntity extends LockableLootTileEntity {
    ...
    public InfiniStorageCrateTileEntity(TileEntityType<?> typeIn) {
        super(typeIn);
    }

    public InfiniStorageCrateTileEntity(){
        this(InfiniTileEntityTypes.INFINI_STORAGE_CRATE.get());
    }
    ...
    public ITextComponent getDefaultName() {
        return new TranslationTextComponent("container.infini_storage_crate");
    }

    @Override
    public Container createMenu(int id, PlayerInventory player) {
        return new InfiniStorageCrateContainer(id, player, this);
    }
    ...
    public static int getPlayersUsing(IBlockReader reader, BlockPos pos){
        ...
        if(blockState.hasTileEntity()){
            ...
            if(tileEntity instanceof InfiniStorageCrateTileEntity){
                return((InfiniStorageCrateTileEntity)tileEntity).numPlayersUsing;
            }
        }
        return 0;
    }

    public static void swapContents(InfiniStorageCrateTileEntity te, InfiniStorageCrateTileEntity otherTe){
