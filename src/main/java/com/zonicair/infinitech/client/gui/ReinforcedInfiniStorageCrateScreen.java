...
@OnlyIn(Dist.CLIENT)
public class ReinforcedInfiniStorageCrateScreen extends ContainerScreen<ReinforcedInfiniStorageCrateContainer> {

    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(InfiniTech.MOD_ID, "textures/gui/reinforced_infini_storage_crate.png");

    public ReinforcedInfiniStorageCrateScreen(ReinforcedInfiniStorageCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
